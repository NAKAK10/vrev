...
export interface CreateIssueBridgeAdapterOptions { provider?: GitHubIssueProvider }
export declare function createIssueBridgeAdapter(review: IssueReviewCapabilityV1, issueTask: IssueTaskCapabilityV1, options?: CreateIssueBridgeAdapterOptions): {
