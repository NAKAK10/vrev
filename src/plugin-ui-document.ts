...
const COMPONENT_PROPS: Readonly<Record<string, readonly string[]>> = {
  ...
  spacer: ["size", "grow"],
  text: ["text", "value", "tone", "variant", "size", "truncate", "preserve_whitespace", "line_clamp", "expandable"],
  ...
  button: ["label", "variant", "size", "disabled", "busy", "pressed", "type", "icon", "line_clamp", "expandable"],
