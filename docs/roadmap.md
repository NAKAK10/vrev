...
- [x] Phase 3: move CLI selection and external AI commands into the AI package; feature requests specify only the required AI mode and never submit a command template
- [x] Phase 4: move review persistence, migration, validation, and status policy to the bundled `review` plugin
- [x] Phase 5: move jobs, coordinator policy, and recovery to `annotation-workflow`, using review and `ai/v1` capabilities
...
- [x] Phase 8: make the declarative plugin surface the default and compose the six bundled feature packages: AI, Firestore, review, annotation-workflow, page-map, and github-issue
...
- [x] Phase 10: complete desktop/tablet/mobile browser acceptance, verify the declarative default and legacy rollback routes, and close package/release hygiene for `1.1.9`
...
### Phase 10 release acceptance (`1.1.9`)
