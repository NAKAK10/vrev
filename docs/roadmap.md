...
- [x] Phase 10: complete desktop/tablet/mobile browser acceptance, verify the declarative default and legacy rollback routes, and close package/release hygiene for `1.1.1`
...
### Phase 10 release acceptance (`1.1.1`)
